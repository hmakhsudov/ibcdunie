...
def handle_dunie(call):
    ...
    with open(file_path, 'rb') as photo:
        bot.send_document(call.message.chat.id, photo, caption="Презентация Дуние")
...
def handle_tools(call):
    bot.send_message(call.message.chat.id, "Вы выбрали раздел: Будущее позитивного планетарного движения")
